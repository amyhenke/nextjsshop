...
var isAuth = middleware(function (_a) { return __awaiter(void 0, [_a], void 0, function (_b) {
    ...
    return __generator(this, function (_c) {
        ...
        // calls server to create the session
        // attach the user to the context for the private procedure
...
// public for endpoints that anyone should be able to call
exports.publicProcedure = t.procedure;
// private endpoints - only for logged in users
