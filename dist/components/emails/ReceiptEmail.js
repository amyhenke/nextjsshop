...
// on backend files, can't do relative imports as issues during deployment
...
var ReceiptEmail = function (_a) {
    ...
    var total = products.reduce(function (accumulator, currentValue) { return accumulator + currentValue.price; }, 0) + 1;
    return (
