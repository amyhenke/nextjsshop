...
var addUser = function (_a) { return __awaiter(void 0, [_a], void 0, function (_b) {
    var user, productData;
    var req = _b.req, data = _b.data;
    return __generator(this, function (_c) {
        user = req.user;
        productData = data;
        return [2 /*return*/, __assign(__assign({}, productData), { user: user.id })];
    });
}); };
...
var syncUser = function (_a) { return __awaiter(void 0, [_a], void 0, function (_b) {
    var fullUser, products, allIDs_1, createProductIDs, dataToUpdate;
    ...
    return __generator(this, function (_c) {
        switch (_c.label) {
            ...
            case 1:
                ...
                createProductIDs = allIDs_1.filter(function (id, index) { return allIDs_1.indexOf(id) === index; });
                dataToUpdate = __spreadArray(__spreadArray([], createProductIDs, true), [doc.id], false);
...
var isAdminOrHasAccess = function () {
    return function (_a) {
        ...
        if (user.role === "admin")
            return true;
        var userProductIDs = (user.products || []).reduce(function (accumulator, product) {
            if (!product)
                return accumulator;
            // just the product id
